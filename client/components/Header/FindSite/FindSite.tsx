...
const FindSite = () => {
  ...
  return (
    <div className='flex items-center text-xs input input-bordered p-0 !outline-1 !outline-offset-0 !outline-primaryLight border-primaryLight focus:border-primaryLight focus:!outline-tertiaryLight focus-within:border-tertiaryLight md:text-sm md:w-[91.8%] md:m-auto h-8 md:h-10 mt-4 md:mt-2  md:!outline-gray-500 md:rounded-sm lg:w-[240px] lg:h-5 lg:rounded-md lg:text-xs'>
